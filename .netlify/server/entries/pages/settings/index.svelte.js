...
const getCategories = async (limit, offset, search) => {
  try {
    ...
    const response = await import_Api_a77dc7b1.A.get(`/categories?limit=${limit}&offset=${offset}${paramSearch}`);
    return response;
  } catch (error) {
...
const ConfML = (0, import_index_7bf676ca.c)(($$result, $$props, $$bindings, slots) => {
  let userMl;
  ...
  return `<div><div class="${"flex flex-wrap justify-between"}"><div class="${"mt-5 relative"}"><input ${$credentials.userMl ? "disabled" : ""} class="${"input-oval max-w-xs "}" name="${"nickname"}" type="${"text"}" required${(0, import_index_7bf676ca.i)("value", nickname, 0)}>
      <label class="${"label-oval"}" for="${"nickname"}">Nickname</label></div>

    <div><button ${$credentials.userMl ? "disabled" : ""} class="${"mt-4 btn ml-4 disabled:bg-gray-500 " + (0, import_index_7bf676ca.e)(!$credentials.userMl ? "ripple" : "")}">Autorizar</button>
      <button ${!$credentials.userMl ? "disabled" : ""} class="${"mt-4 btn ml-4 disabled:bg-gray-500 " + (0, import_index_7bf676ca.e)($credentials.userMl ? "ripple" : "")}">Desvincular</button></div></div></div>
${userMl ? `<div class="${"mt-4 p-4 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-300 dark:border-gray-800"}"><p>${(0, import_index_7bf676ca.e)(userMl.firstName)}
      ${(0, import_index_7bf676ca.e)(userMl.lastName)} - ${(0, import_index_7bf676ca.e)(userMl.identification.type)}
      ${(0, import_index_7bf676ca.e)(userMl.identification.number)} - ML ID ${(0, import_index_7bf676ca.e)(userMl.mlUserId)}</p>
    <hr class="${"border-gray-700"}">

    <p class="${"mt-4 text-left text-gray-600"}">${(0, import_index_7bf676ca.e)(userMl.email)}</p>
    <p class="${"text-left text-gray-600"}">${(0, import_index_7bf676ca.e)(userMl.phone.area_code)}
      ${(0, import_index_7bf676ca.e)(userMl.phone.extension)}
      ${(0, import_index_7bf676ca.e)(userMl.phone.number)}</p>
    <p class="${"text-left text-gray-600"}">${(0, import_index_7bf676ca.e)(userMl.address.address)}
...
var Categories_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => '@media only screen and (max-width: 1024px){td.svelte-a5i4gb:nth-of-type(1):before{content:"Id"}td.svelte-a5i4gb:nth-of-type(2):before{content:"Categor\xEDa"}td.svelte-a5i4gb:nth-of-type(3):before{content:"Acciones"}input.svelte-a5i4gb:-webkit-autofill,input.svelte-a5i4gb:-webkit-autofill:hover,input.svelte-a5i4gb:-webkit-autofill:focus{-webkit-transition:background-color 5000s ease-in-out 0s;transition:background-color 5000s ease-in-out 0s}}')();
const css$2 = {
...
const Categories = (0, import_index_7bf676ca.c)(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    <span class="${"text-lg ml-1"}">Categor\xEDas: ${(0, import_index_7bf676ca.e)(pagination.total)}</span></div>
  <div class="${"flex items-center"}"><input class="${"text-black w-[250px] pl-1 svelte-a5i4gb"}" name="${"search"}" type="${"search"}"${(0, import_index_7bf676ca.i)("value", search, 0)}>
    </div>
...
<table id="${"tblData"}" class="${"responsive-table"}"><thead><tr><th>ID</th>
  ...
  <tbody>${(0, import_index_7bf676ca.b)(categories, (category) => {
      return `<tr><td class="${"svelte-a5i4gb"}">${(0, import_index_7bf676ca.e)(category.id)}</td>
        <td class="${"svelte-a5i4gb"}">${(0, import_index_7bf676ca.e)(category.fullName)}</td>
        <td class="${"svelte-a5i4gb"}"><button${(0, import_index_7bf676ca.i)("id", category.id, 0)}><i class="${"material-icons"}" style="${"color: red"}">delete</i></button></td>
      </tr>`;
    })}</tbody></table>
...
${(0, import_index_7bf676ca.v)(import_Modal2_6d227b9b.M, "Modal2").$$render($$result, { this: modalDelete }, {
      ...
      default: () => {
        return `<h2 class="${"text-2xl text-center"}">Eliminar Categor\xEDa ${(0, import_index_7bf676ca.e)(currentCat.id)} - ${(0, import_index_7bf676ca.e)(currentCat.name)}</h2>
...
${(0, import_index_7bf676ca.v)(import_Modal2_6d227b9b.M, "Modal2").$$render($$result, { this: modalCreate }, {
    ...
    ${results.length > 0 ? `<select class="${"block ml-auto mr-auto justify-center mt-4 w-fit border bg-transparent overflow-y-hidden"}" name="${"catPredictor"}" id="${"catPredictor"}"${(0, import_index_7bf676ca.i)("size", results.length + 1, 0)}><option disabled class="${"border border-gray-600 border-solid"}" value="${"false"}">Seleccione una categor\xEDa</option>${(0, import_index_7bf676ca.b)(results, (category) => {
          return `<option class="${"h-fit whitespace-normal border border-gray-600 border-solid"}"${(0, import_index_7bf676ca.i)("value", category, 0)}>${(0, import_index_7bf676ca.b)(category.pathFromRoot, (parent, index) => {
            return `${index === 0 ? `${(0, import_index_7bf676ca.e)(parent.name)}` : `\xA0/\xA0${(0, import_index_7bf676ca.e)(parent.name)}`}`;
          })}
          </option>`;
        })}</select>
    ...
    ${isLoading ? `${(0, import_index_7bf676ca.v)(import_Spinner_409a666b.S, "Spinner").$$render($$result, {}, {}, {})}` : ``}</div>`;
      }
    })}`;
  } while (!$$settled);
...
const General = (0, import_index_7bf676ca.c)(($$result, $$props, $$bindings, slots) => {
  let $settings, $$unsubscribe_settings;
  $$unsubscribe_settings = (0, import_index_7bf676ca.a)(import_stores_c1931941.s, (value) => $settings = value);
  $$unsubscribe_settings();
...
const TABS = {};
const Tabs = (0, import_index_7bf676ca.c)(($$result, $$props, $$bindings, slots) => {
  const tabs = [];
  const panels = [];
...
const TabList = (0, import_index_7bf676ca.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="${"tab-list svelte-t7wjas"}">${slots.default ? slots.default({}) : ``}
</div>`;
});
const TabPanel = (0, import_index_7bf676ca.c)(($$result, $$props, $$bindings, slots) => {
  let $selectedPanel, $$unsubscribe_selectedPanel;
  const panel = {};
  const { registerPanel, selectedPanel } = (0, import_index_7bf676ca.h)(TABS);
  $$unsubscribe_selectedPanel = (0, import_index_7bf676ca.a)(selectedPanel, (value) => $selectedPanel = value);
  registerPanel(panel);
...
const Tab = (0, import_index_7bf676ca.c)(($$result, $$props, $$bindings, slots) => {
  let $selectedTab, $$unsubscribe_selectedTab;
  const tab = {};
  const { registerTab, selectTab, selectedTab } = (0, import_index_7bf676ca.h)(TABS);
  $$unsubscribe_selectedTab = (0, import_index_7bf676ca.a)(selectedTab, (value) => $selectedTab = value);
  registerTab(tab);
  $$result.css.add(css);
...
const Settings = (0, import_index_7bf676ca.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_7bf676ca.v)(Tabs, "Tabs").$$render($$result, {}, {}, {
    default: () => {
      return `${(0, import_index_7bf676ca.v)(TabList, "TabList").$$render($$result, {}, {}, {
        default: () => {
          return `${(0, import_index_7bf676ca.v)(Tab, "Tab").$$render($$result, {}, {}, {
            default: () => {
              return `General`;
            }
          })}
    ${(0, import_index_7bf676ca.v)(Tab, "Tab").$$render($$result, {}, {}, {
            default: () => {
  ...
  ${(0, import_index_7bf676ca.v)(TabPanel, "TabPanel").$$render($$result, {}, {}, {
        default: () => {
          return `${(0, import_index_7bf676ca.v)(General, "General").$$render($$result, {}, {}, {})}`;
        }
      })}

  ${(0, import_index_7bf676ca.v)(TabPanel, "TabPanel").$$render($$result, {}, {}, {
        default: () => {
          return `${(0, import_index_7bf676ca.v)(Categories, "Categories").$$render($$result, {}, {}, {})}`;
        }
      })}
  ...
  ${(0, import_index_7bf676ca.v)(TabPanel, "TabPanel").$$render($$result, {}, {}, {
        default: () => {
          return `${(0, import_index_7bf676ca.v)(ConfML, "ConfML").$$render($$result, {}, {}, {})}`;
        }
      })}`;
    }
  })}`;
