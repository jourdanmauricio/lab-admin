...
var import_stores_68392f64 = require("./stores-68392f64.js");
const Footer = (0, import_index_9af3cff5.c)(($$result, $$props, $$bindings, slots) => {
...
const Snackbar = (0, import_index_9af3cff5.c)(($$result, $$props, $$bindings, slots) => {
  let $notification, $$unsubscribe_notification;
  $$unsubscribe_notification = (0, import_index_9af3cff5.a)(import_stores_68392f64.n, (value) => $notification = value);
  function handleType() {
  ...
  return `${$notification.show ? `<div class="${(0, import_index_9af3cff5.e)((0, import_index_9af3cff5.f)(handleType())) + " svelte-1h4ah5m"}">${(0, import_index_9af3cff5.e)($notification.message)}</div>` : ``}`;
});
